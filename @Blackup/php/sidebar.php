    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-header pl-3 pr-3"><small>ภาพรวมและความเคลื่อนไหวระบบ</small></li>
                <li class="nav-item has-treeview <? echo ($menu_page_group == "dashboard" ? "menu-open" : ""); ?>">
                    <a class="nav-link <? echo ($menu_page_group == "dashboard" ? "active" : ""); ?>"> 
                        <i class="nav-icon fas fa-tachometer-alt <? echo ($menu_page_group == "dashboard" ? "menu-main-active-color" : "menu-main-unactive-color"); ?>"></i>
                        <p class="<? echo ($menu_page_group == "dashboard" ? "menu-main-active-color" : "menu-main-unactive-color"); ?>">
                            <b>Dashboard ระบบ</b>
                            <i class="right fas fa-angle-left"></i>
                        </p>
                    </a>
                    <ul class="nav nav-treeview <? echo ($menu_page_name == "dashboard_screen_1" ? "menu-sub-active-bg-color" : ""); ?>">
                        <li class="nav-item">
                            <a href="<? echo $root_web_path ?>/pages/staff_page/dashboard.php" class="nav-link <? echo ($menu_page_name == "dashboard_screen_1" ? "active" : ""); ?>"> 
                                <i class="fas fa-desktop nav-icon <? echo ($menu_page_name == "dashboard_screen_1" ? "menu-sub-active-color" : ""); ?>"></i>
                                <p class="<? echo ($menu_page_name == "dashboard_screen_1" ? "menu-sub-active-color" : ""); ?>">Dashboard หน้าจอ</p>
                                <span class="right badge <? echo ($menu_page_name == "dashboard_screen_1" ? "badge-light text-warning" : "badge-secondary"); ?>">1</span> 
                            </a>
                        </li>
                    </ul>
                </li>
