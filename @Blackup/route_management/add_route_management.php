...
} else if ($_COOKIE["idAccount"] != $_SESSION["idAccount"] || $_COOKIE["keyAccount"] != $_SESSION["keyAccount"]) {
...
<body class="sidebar-mini layout-fixed sidebar-collapse">
    <div class="wrapper">
                                        ...
                                        <form role="form" enctype="multipart/form-data" id="form_add_route_management">
                                            <div class="row">
                                                <div class="row pl-3 pr-0 mb-3 w-100">
                                                    ...
                                                    <div class="form-group col-md-6 col-12 pl-md-2 pr-md-1 pl-0 pr-0 mb-md-1 mb-2" id="">
                                                    ...
                                                    <div class="form-group col-md-6 col-12 pl-md-1 pr-md-2 pl-0 pr-0 mb-md-1 mb-2" id="">
                                                        ...
                                                        <input type="text" class="using-custom-font form-control" name="" placeholder="รายละเอียด / ข้อมูลประจำเส้นทางเดินรถ">
                                                    </div>
                                                    <div class="form-group col-md-6 col-12 pl-md-2 pr-md-1 pl-0 pr-0 mb-md-1 mb-2" id="route_color_1">
                                                        ...
                                                        <div class="d-flex">
                                                            <input type="text" class="using-custom-font form-control ml-0 mr-1" name="" onfocus="setStaticText(this, 'สี')" oninput="setNameColor(this)" onfocusout="clearStaticText(this)" placeholder="ชื่อสีเส้นทางเดินรถ">
                                                ...
                                                <div class="row pl-3 pr-0 mb-3 w-100">
                                                    ...
                                                    <div class="form-group col-md-6 col-12 pl-md-2 pr-md-2 pl-0 pr-0 mb-md-1 mb-2" id="">
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="input-group ml-0 mr-2">
                                                                <input type="text" class="using-custom-font form-control" name="" oninput="detectDecimal(this)" onfocusout="setDecimal(this, 2)" placeholder="ค่าบริการเริ่มต้น (ขั้นต่ำ)">
                                                            ...
                                                            <div class="input-group ml-2 mr-0">
                                                                <input type="text" class="using-custom-font form-control" name="" oninput="detectDecimal(this)" onfocusout="setDecimal(this, 2)" placeholder="ค่าบริการสูงสุด">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text using-custom-font">บ.</span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row pl-3 pr-0 mb-3 w-100">
                                                    ...
                                                    <div class="form-group col-md-3 col-12 pl-md-2 pr-md-1 pl-0 pr-0 mb-md-1 mb-2" id="">
                                                    ...
                                                    <div class="form-group col-md-3 col-12 pl-md-2 pr-md-1 pl-0 pr-0 mb-md-1 mb-2" id="">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="using-custom-font form-control" name="service_count_round" oninput="detectInteger(this, 120)" onfocusout="calculateServiceEndTime()" maxlength="4" placeholder="จำนวนรอบให้บริการ">
                                                            <div class="input-group-append">
                                                    ...
                                                    <div class="form-group col-md-4 col-12 pl-md-2 pr-md-1 pl-0 pr-0 mb-md-1 mb-2" id="">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="using-custom-font form-control" name="" oninput="detectInteger(this, 1440)" maxlength="4" placeholder="เวลาที่ใช้ให้บริการเส้นทางเดินรถ">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text using-custom-font">นาที (น.)</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row pl-3 pr-0 w-100">
                                                    <div class="col-12 pl-0 mt-1 mb-2">
                                                        ...
                                                        <br>
                                                        <small class="text-secondary using-custom-font"> <span class="text-info text-bold">*</span> <b> 2. ตรวจสอบข้อมูล</b> จุดเริ่มต้นให้บริการ และจุดสิ้นสุดให้บริการ ทั้งเที่ยวขาไป และเที่ยวขากลับ</small>
                                                        <br>
                                                    ...
                                                    <div class="form-group col-md-12 col-12 pl-md-2 pr-md-1 pl-0 pr-0 mb-md-1 mb-2" id="input_password">
                                                        ...
                                                        <div class="col-12 pl-0 pr-0 mb-2">
                                                            <div class="d-md-flex d-block">
                                                                <select class="col-md-2 col-12 custom-select using-custom-font bg-primary pl-md-3 pl-2 pr-md-1 pr-0 mb-2" id="createRoutePinType">
                                                                ...
                                                                <div class="col-md col-12 input-group p-0 pl-md-2 pl-0 pr-md-1 pr-0 mb-2">
                                                                    <div class="input-group-prepend">
                                                                    ...
                                                                    <input type="text" class="using-custom-font form-control" name="latitudePoint" oninput="detectLocationPoint(this)" onfocusout="setDecimal(this, 6)" max="16" placeholder="ตำแหน่งละติจูด">
                                                                </div>
                                                                <div class="col-md col-12 input-group p-0 pl-0 pr-0 mb-2">
                                                                    <div class="input-group-prepend">
                                                                    ...
                                                                    <input type="text" class="using-custom-font form-control" name="longitudePoint" oninput="detectLocationPoint(this)" onfocusout="setDecimal(this, 6)" max="16" placeholder="ตำแหน่งลองจิจูด">
                                                                </div>
                                                                <div class="col-md-2 col-12 input-group p-0 pl-md-2 pl-0 pr-0 mb-2">
                                                                    <button type="button" class="btn btn-block btn-success using-custom-font" onclick="setCreateRoute()"><i class="fas fa-plus"></i> เพิ่มข้อมูล</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-md-6 col-12 input-group p-0 pr-md-2 pr-0 mt-2">
                                                                    <div class="col-12 d-flex flex-column side-form p-0">
                                                                        <div>
                                                                            ...
                                                                            <div class="input-group">
                                                                                <input type="text" class="using-custom-font form-control custom-input-disabled" name="start_point_forward" oninput="" placeholder="ตำแหน่งจุดเริ่มต้นให้บริการ" disabled>
                                                                                <div class="input-group-append">
                                                                                    <button type="button" class="btn btn-warning using-custom-font text-white" onclick="" disabled><i class="fas fa-edit"></i><span class="d-md-inline d-none"> แก้ไข</span></button>
                                                                                </div>
                                                                            </div>
                                                                            <hr class="mb-1">
                                                                        </div>
                                                                        <div class="h-100">
                                                                            <label class="d-flex custom-form-label mt-1"><span>จุดเบี่ยงเส้นทาง (เที่ยวขาไป) <span class="text-warning text-bold">*</span>
                                                                                ...
                                                                                <span class="text-muted ml-auto mr-1">(0 จุดเบี่ยง)</span>
                                                                            </label>
                                                                            <div class="h-100 site-form border pt-md-1 pt-0 pb-2 pl-md-2 pl-1 pr-md-3 pr-2" id="deviate_forward">
                                                                                <!-- <div class="input-group pt-1">
                                                                                <div class="input-group-prepend">
                                                                                    <button type="button" class="btn btn-outline-warning" onclick=""><i class="far fa-trash-alt"></i></button>
                                                                                </div>
                                                                                <input type="text" class="border-warning using-custom-font form-control custom-input-disabled" value="Point 1 = [lon: 24.2135453, lat: 98.5135158]" disabled>
                                                                                <div class="input-group-append">
                                                                                    <button type="button" class="btn btn-warning using-custom-font text-white" onclick=""><i class="fas fa-edit"></i><span class="d-md-inline d-none"> แก้ไข</span></button>
                                                                                </div>
                                                                            </div> -->
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6 col-12 input-group p-0 pl-md-2 pl-0 mt-2">
                                                                    <div class="col-12 d-flex flex-column side-form p-0">
                                                                        <div>
                                                                            ...
                                                                            <div class="input-group">
                                                                                <input type="text" class="using-custom-font form-control custom-input-disabled" name="start_point_backward" oninput="" placeholder="ตำแหน่งจุดเริ่มต้นให้บริการ" disabled>
                                                                                <div class="input-group-append">
                                                                                    <button type="button" class="btn btn-warning using-custom-font text-white" onclick="" disabled><i class="fas fa-edit"></i><span class="d-md-inline d-none"> แก้ไข</span></button>
                                                                                </div>
                                                                            </div>
                                                ...
                                                <div class="form-group col-12 pl-md-2 pr-md-2 pl-0 pr-0 mt-2 mb-0" id="input_verify">
                                                    ...
                                                    <div class="w-100 row d-flex justify-content-center pl-md-0 pr-md-0 pl-5 pr-5 m-0">
                                                        <button type="button" class="col-md-3 col-12 btn btn-success using-custom-font pt-2 pb-2 m-2" onclick="verifyInputForm('openForm')"><i class="far fa-check-circle"></i> ตรวจสอบ</button>
                                                    </div>
                                                    <hr>
                                                </div>
                                            </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title font-weight-norma using-custom-font"><i class="far fa-check-circle"></i> ตรวจสอบ</h5>
                    </div>
        ...
        <!-- LogOut Modal -->
        <?include $root_path . "/include/modal_logout.php"?>
        <!-- Footer -->
