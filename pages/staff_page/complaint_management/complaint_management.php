...
$use_path = $root_path;
$menu_page_group = "complaint_management";
$menu_page_name = "complaint_management";
...
<head>
    ...
    <title>TRC Tracking - ภาพรวมคำร้องเรียน และปัญหาการใช้บริการ</title>
...
<body class="sidebar-mini layout-fixed sidebar-collapse">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10 d-flex justify-content-center justify-content-sm-start">
                            <h4 class="m-0 text-dark text-header-web text-center">ภาพรวมคำร้องเรียน และปัญหาการใช้บริการ</h4>
                        </div>
                            ...
                            <div class="container-fluid h-100 custom-widget-box bg-primary">
                                <div class="pt-4 pb-4 pl-3 pr-3">
                                    ...
                                    <div class="widget-content text-xl-left text-center pb-1">
                                        ...
                                        <div class="main-text">จำนวนคำร้องเรียนทั้งหมด</div>
                                    ...
                                    <div class="row justify-content-center mb-2 mb-md-0">
                                        <div class="col-sm-12 col-md-6 d-flex align-items-center justify-content-center justify-content-md-start p-o">
                                            <h3 class="card-title using-custom-font mt-2 mb-2">
                                                <b>รายการคำร้องเรียน และปัญหาการใช้บริการ</b>
                                            </h3>
                                        </div>
    ...
    <script type="text/javascript" src="/TRC_Tracking/src/js/complaint_management/complaint_management.js"></script>
</body>
