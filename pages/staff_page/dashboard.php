...
$menu_page_group = "dashboard";
$menu_page_name = "dashboard_screen_1";
...
<head>
    ...
    <title>TRC Tracking - Dashboard System</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10">
                            <h4 class="m-0 text-dark text-header-web">Dashboard แสดงความเคลื่อนไหวระบบ</h4>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    <hr>
                </div><!-- /.container-fluid -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="/TRC_Tracking/src/dist/img/user1-128x128.jpg" alt="message user image">
                                            <!-- /.direct-chat-img -->
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="/TRC_Tracking/src/dist/img/user3-128x128.jpg" alt="message user image">
                                            <!-- /.direct-chat-img -->
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="/TRC_Tracking/src/dist/img/user1-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="/TRC_Tracking/src/dist/img/user7-128x128.jpg">
                                                    <div class="contacts-list-info">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="/TRC_Tracking/src/dist/img/user3-128x128.jpg">
                                                    <div class="contacts-list-info">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="/TRC_Tracking/src/dist/img/user5-128x128.jpg">
                                                    <div class="contacts-list-info">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="/TRC_Tracking/src/dist/img/user6-128x128.jpg">
                                                    <div class="contacts-list-info">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="/TRC_Tracking/src/dist/img/user8-128x128.jpg">
                                                    <div class="contacts-list-info">
