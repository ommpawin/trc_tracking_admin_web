...
<head>
    ...
    <title>TRC Tracking - แก้ไขบัญชีผู้ขับ</title>
...
<body class="sidebar-mini layout-fixed sidebar-collapse">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10 d-flex justify-content-center justify-content-sm-start">
                            <h4 class="m-0 text-dark text-header-web text-center">แก้ไขบัญชีผู้ขับ</h4>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body pad table-responsive pl-md-4 pr-md-4 pl-2 pr-2 pt-4">
                                    <div class="container">
                                        ...
                                        <form role="form" enctype="multipart/form-data" id="form_edit_driver_account">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6 col-12 pl-md-1 pr-md-2 pl-0 pr-0 mb-md-1 mb-2">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-append">
                                                                <button class="btn btn-warning text-white using-custom-font" type="button" onclick="generatePasswordInput(this)">เปลี่ยนแปลงรหัสผ่าน</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-6 col-12 pl-md-2 pr-md-1 pl-0 pr-0 mb-md-1 mb-2">
                                                ...
                                                <div class="row pl-3 pr-0 w-100">
                                                    <div class="col-12 pl-0 mt-1 mb-2">
                                                        <label class="custom-form-header">ข้อมูลบัญชีผู้ขับ</label>
                                                    </div>
                                                    <div class="form-group col-md-6 col-12 pl-md-2 pr-md-2 pl-0 pr-0 mb-md-1 mb-2" id="">
                                                        <label class="custom-form-label">สถานะบัญชีผู้ขับ (Access Status) <span class="text-danger text-bold">*</span></label>
                                                        <select class="using-custom-font form-control" name="access_status" onchange="setAccessStatusOption(this.value)">
                        ...
                        <div>
                            <form>
                                ...
                                <div class="form-group mb-1">
                                    ...
                                    <input type="text" class="form-control text-center using-custom-font custom-input-disabled" id="verify_access_status" disabled>
                                </div>
                            </form>
                            <hr>
    ...
    <script type="text/javascript" src="/TRC_Tracking/src/js/driver_account/edit_driver_account.js"></script>
</body>
