...
<head>
    ...
    <title>TRC Tracking - แสดงข้อมูลบัญชีผู้ขับ</title>
...
<body class="sidebar-mini layout-fixed sidebar-collapse">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10 d-flex justify-content-center justify-content-sm-start">
                            <h4 class="m-0 text-dark text-header-web text-center">แสดงข้อมูลบัญชีผู้ขับ</h4>
                        </div>
                                    ...
                                    <div class="container">
                                        <div class="row justify-content-center p-md-2 p-1 mb-3">
                                            <div class="col-md-10 col-12 d-md-flex d-block">
                                                <div class="col-md-6 col-12 d-flex justify-content-center align-items-center mt-md-0 mt-4 mb-md-0 mb-4">
                                                    <div class="w-100">
                                                        <p class="text-center profile-main-content-name mb-2" id="name"></p>
                                                        <p class="text-center profile-main-content-phone-number mb-3" id="phoneNumber"></p>
                                                        <div class="d-flex justify-content-center" id="status_badge"></div>
                                                    </div>
                                                </div>
                                                <hr class="d-md-none d-flex">
                                                <div class="col-md-6 col-12 d-flex justify-content-center align-items-center mt-md-0 mt-4">
                                                    <div class="w-100">
                                                        <p class="text-center profile-main-content-idRoute mb-2" id="idRoute"></p>
                                                        <p class="text-center profile-main-content-nameRoute mb-3" id="nameRoute"></p>
                                                        <p class="text-center profile-main-content-typeRoute mb-1" id="typeRoute"></p>
                                                        <p class="text-center profile-main-content-colorRoute mb-3" id="colorRoute"></p>
                                                        <div class="d-flex justify-content-center">
                                                            <button type="button" class="btn btn-outline-primary btn-xs using-custom-font" onclick="linkToRoute()"><i class="fas fa-search"></i> แสดงข้อมูลเส้นทางเดินรถ</button>
                                                        </div>
                                        ...
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="row col-md-10 col-12">
                                                <div class="w-100 d-md-flex d-block pl-2 pr-2 mt-1 mb-1">
                                                    <p class="col-md-6 col-12 profile-main-text d-flex align-items-center mt-2 mb-2"> รหัสบัญชีผู้ขับ</p>
                                                    <p class="profile-main-text d-md-flex d-none align-items-center mt-2 mb-2 mr-3"> :</p>
                                                    <input type="text" class="col-md-6 col-12 custom-input-disabled form-control mt-1 mb-1" name="driver_id_account" value="-" disabled>
                                                </div>
                                                <div class="w-100 d-md-flex d-block pl-2 pr-2 mt-1 mb-1">
                                                    <p class="col-md-6 col-12 profile-main-text d-flex align-items-center mt-2 mb-2"> รหัสผ่าน (Password)</p>
                                                    <p class="profile-main-text d-md-flex d-none align-items-center mt-2 mb-2 mr-3"> :</p>
                                                    <div class="col-md-6 col-12 input-group p-0 mt-1 mb-1">
                                                        <input type="password" class="form-control using-custom-font" name="password" value="-" disabled>
                                                        <div class="input-group-append">
                                                            <button class="btn btn-success text-white using-custom-font" type="button" onclick="showUserPassword(this)" name="show_password_button" >แสดงรหัสผ่าน</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="w-100 d-md-flex d-block pl-2 pr-2 mt-1 mb-1">
                                                    <p class="col-md-6 col-12 profile-main-text d-flex align-items-center mt-2 mb-2"> เลขประจำตัวประชาชน</p>
                                                    <p class="profile-main-text d-md-flex d-none align-items-center mt-2 mb-2 mr-3"> :</p>
                                                    <p class="col-md-6 col-12 profile-sub-text d-flex align-items-center mt-2 mb-2 ml-md-0 ml-2" id="identificationNumber"></p>
                                                </div>
                                                <div class="w-100 d-md-flex d-block pl-2 pr-2 mt-1 mb-1">
                                                    <p class="col-md-6 col-12 profile-main-text d-flex align-items-center mt-2 mb-2"> ที่อยู่</p>
                                                    <p class="profile-main-text d-md-flex d-none align-items-center mt-2 mb-2 mr-3"> :</p>
                                                    <p class="col-md-6 col-12 profile-sub-text text-justify mt-2 mb-2 ml-md-0 ml-2" id="address"></p>
                                                </div>
                                                <div class="w-100 d-md-flex d-block pl-2 pr-2 mt-1 mb-1">
                                                    <p class="col-md-6 col-12 profile-main-text d-flex align-items-center mt-2 mb-2"> เลขที่ใบอนุญาตขับรถ</p>
                                                    <p class="profile-main-text d-md-flex d-none align-items-center mt-2 mb-2 mr-3"> :</p>
                                                    <p class="col-md-6 col-12 profile-sub-text d-flex align-items-center mt-2 mb-2 ml-md-0 ml-2" id="license_driver"></p>
                                                </div>
                                                <div class="w-100 mt-1 mb-1">
                                                    <hr>
                                                </div>
    ...
    <script type="text/javascript" src="/TRC_Tracking/src/js/driver_account/profile_driver_account.js"></script>
</body>
