...
$use_path = $root_path;
$menu_page_group = "external_account";
$menu_page_name = "external_account";
...
<head>
    ...
    <title>TRC Tracking - ภาพรวมบัญชีผู้ใช้ระบบภายนอก</title>
...
<body class="sidebar-mini layout-fixed sidebar-collapse">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10 d-flex justify-content-center justify-content-sm-start">
                            <h4 class="m-0 text-dark text-header-web text-center">ภาพรวมบัญชีผู้ใช้ระบบภายนอก</h4>
                        </div>
                            ...
                            <div class="container-fluid h-100 custom-widget-box bg-primary">
                                <div class="pt-4 pb-4 pl-3 pr-3">
                                    ...
                                    <div class="widget-content text-xl-left text-center pb-1">
                                        ...
                                        <div class="main-text">จำนวนบัญชีผู้ใช้ทั้งหมด</div>
                        ...
                        <div class="col-md-3 col-6 mt-md-0 mt-2">
                            <div class="container-fluid h-100 custom-widget-box bg-info">
                                <div class="pt-4 pb-4 pl-3 pr-3">
                                    ...
                                    <div class="widget-content text-xl-left text-center pb-1">
                                        <h2 class="dataWidgets">-</h2>
                                        <div class="main-text">จำนวนบัญชีผู้ใช้ที่ถูกระงับใช้งาน</div>
                                        <div class="sub-text">(จากสถานะ 0 บัญชีผู้ใช้ทั้งหมด)</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-6 mt-md-0 mt-2">
                            <div class="container-fluid h-100 custom-widget-box bg-danger">
                                <div class="pt-4 pb-4 pl-3 pr-3">
                                    ...
                                    <div class="widget-content text-xl-left text-center pb-1">
                                        <h2 class="dataWidgets">- / -</h2>
                                        <div class="main-text">จำนวนบัญชีผู้ใช้ที่ถูกยกเลิกการใช้งาน</div>
                                        <div class="sub-text">(จากสถานะ 0 บัญชีผู้ใช้ทั้งหมด)</div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row justify-content-center mb-2 mb-md-0">
                                        <div class="col-sm-12 col-md-6 d-flex align-items-center justify-content-center justify-content-md-start p-o">
                                            <h3 class="card-title using-custom-font mt-2 mb-2">
                                                <b>รายการบัญชีผู้ใช้ระบบภายนอก</b>
                                            </h3>
                                        </div>
    ...
    <script type="text/javascript" src="/TRC_Tracking/src/js/external_account/external_account.js"></script>
</body>
