...
<head>
    ...
    <title>TRC Tracking - แก้ไขข้อมูลบัญชีผู้ใช้ระบบภายใน</title>
...
<body class="sidebar-mini layout-fixed sidebar-collapse">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10 d-flex justify-content-center justify-content-sm-start">
                            <h4 class="m-0 text-dark text-header-web text-center">แก้ไขข้อมูลบัญชีผู้ใช้ระบบภายใน</h4>
                        </div>
                    </div>
                    <hr>
                </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="row col-md-10 col-12">
                                                ...
                                                <form class="w-100" enctype="multipart/form-data" id="form_edit_internal_account">
                                                    <div class="w-100 d-md-flex d-block pl-2 pr-2 mt-1 mb-2">
                                                        ...
                                                        <select class="col-md-6 col-12 using-custom-font form-control mt-1 mb-1" onchange="setAccessLevelOption(this.value)" name="access_level">
                                                    ...
                                                    <div class="w-100 d-md-flex d-block pl-2 pr-2 mt-2 mb-2">
                                                        ...
                                                        <p class="profile-main-text d-md-flex d-none align-items-center mt-1 mb-2 mr-3"> :</p>
                                                        <select class="col-md-6 col-12 using-custom-font form-control mt-1 mb-1" onchange="setAccessStatusOption(this.value)" name="access_status">
                                                            <option value="3" class="text-success">ใช้งาน</option>
                                                            <option value="2" class="text-info">ระงับการใช้งานชั่วคราว</option>
                                                            <option value="1" class="text-danger">ยกเลิกการใช้งาน</option>
                                                        </select>
                                                    </div>
                                                    <div class="w-100 d-md-flex d-block pl-2 pr-2 mt-2 mb-2">
                                                        ...
                                                        <div class="col-md-6 col-12 input-group p-0 mt-1 mb-1">
                                                            <input type="text" class="form-control custom-password-disabled using-custom-font" name="password_status" disabled>
                                                            <div class="input-group-append">
                                                                <button class="btn btn-secondary using-custom-font" type="button" onclick="changeUserPassword()" name="change_password_button" disabled>ใช้รหัสผ่านเริ่มต้น</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="w-100 d-md-flex d-block pl-2 pr-2 mt-2 mb-2">
                                                        ...
                                                        <p class="profile-main-text d-md-flex d-none align-items-center mt-1 mb-2 mr-3"> :</p>
                                                        <input type="text" class="col-md-6 col-12 using-custom-font form-control mt-1 mb-1" name="role_ids">
                                                    </div>
                                                    <div class="w-100 mt-2 mb-2">
                                                        <hr>
                                                    </div>
                                                    <div class="w-100 row d-flex justify-content-center pl-md-0 pr-md-0 pl-5 pr-5 m-0">
                                                        <button id="buttonSaveData" type="button" class="col-md-3 col-12 btn btn-primary using-custom-font pt-2 pb-2 m-2" onclick="showModal('#saveChangeData')" disabled><i class="fas fa-save"></i> บันทึกข้อมูล</button>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="col-12">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" id="modalContentSaveChangeData">
                    <div class="modal-header">
                        <h5 class="modal-title using-custom-font"> เปลี่ยนแปลงรหัสผ่านบัญชีผู้ใช้</h5>
                    </div>
    ...
    <script type="text/javascript" src="/TRC_Tracking/src/js/internal_account/edit_internal_account.js"></script>
</body>
