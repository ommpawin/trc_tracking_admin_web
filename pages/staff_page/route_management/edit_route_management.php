...
<head>
    ...
    <title>TRC Tracking - แก้ไขเส้นทางเดินรถ</title>
...
<body class="sidebar-mini layout-fixed sidebar-collapse">
    <div class="wrapper">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10 d-flex justify-content-center justify-content-sm-start">
                            <h4 class="m-0 text-dark text-header-web text-center">แก้ไขเส้นทางเดินรถ</h4>
                        </div>
                    </div>
                    <hr>
                </div>
                            ...
                            <div class="card">
                                <div class="card-body pad table-responsive pl-md-4 pr-md-4 pl-2 pr-2 pt-4">
                                    <div class="container">
                                        ...
                                        <form role="form" enctype="multipart/form-data" id="form_edit_route_management">
                                            <div class="row">
                                                ...
                                                <div class="row pl-3 pr-0 mb-3 w-100">
                                                    ...
                                                    <div class="form-group col-md-12 col-12 pl-md-2 pr-md-1 pl-0 pr-0 mb-md-1 mb-2" id="">
                                                        ...
                                                        <div class="col-12 pl-0 pr-0 mb-1">
                                                            <div class="d-md-flex d-block" id="routeMapSelectType">
                                                                <select class="col-md-2 col-12 custom-select bg-primary using-custom-font pl-md-3 pl-2 pr-md-1 pr-0 mb-1" id="createRoutePinType">
                                                                    <option value="0" disabled>จุดเริ่มต้น</option>
                                                                    <option value="1" disabled>จุดสิ้นสุด</option>
                                                                    <option value="2">จุดเบี่ยงขาไป</option>
                                                                    <option value="3">จุดเบี่ยงขากลับ</option>
                                                                </select>
                                                ...
                                                <div class="row pl-3 pr-0 w-100">
                                                    <div class="col-12 pl-0 mt-1 mb-2">
                                                        <label class="custom-form-header">ข้อมูลบัญชีเส้นทางเดินรถ</label>
                                                    </div>
                                                    <div class="form-group col-md-6 col-12 pl-md-2 pr-md-2 pl-0 pr-0 mb-md-1 mb-2" id="">
                                                        <label class="custom-form-label">สถานะเส้นทาง (Route Status) <span class="text-danger text-bold">*</span></label>
                                                        <select class="using-custom-font form-control" name="route_status" onchange="setAccessStatusOption(this.value)">
                                                            <option value="3" class="text-success">ให้บริการ</option>
                                                            <option value="2" class="text-info">ระงับการให้บริการชั่วคราว</option>
                                                            <option value="1" class="text-danger">ยกเลิกการให้บริการ</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-12 pl-md-2 pr-md-2 pl-0 pr-0 mt-2 mb-0" id="input_verify">
                                                    ...
                                                    <div class="w-100 row d-flex justify-content-center pl-md-0 pr-md-0 pl-5 pr-5 m-0">
                                                        <button type="button" class="col-md-3 col-12 btn btn-success using-custom-font pt-2 pb-2 m-2" onclick="verifyInputForm()" disabled=true><i class="far fa-check-circle"></i> ตรวจสอบ</button>
                                                    </div>
                                                    <hr>
                                                </div>
                                        </form>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title using-custom-font"><i class="far fa-check-circle"></i> ตรวจสอบการแก้ไข</h5>
                    </div>
                        ...
                        <div>
                            <form>
                                <div class="form-group mb-1">
                                    ...
                                    <input type="text" class="form-control using-custom-font custom-input-disabled" id="verify_name_route_service" disabled>
                                </div>
                                <div class="form-group mb-1">
                                    <label class="custom-form-label">รายละเอียด / ข้อมูลประจำเส้นทางเดินรถ (Keyword สำหรับค้นหา)</label>
                                    <input type="text" class="form-control using-custom-font custom-input-disabled" id="verify_route_keyword_detail" disabled>
                                </div>
                                <div class="form-group mb-1">
                                    ...
                                    <div class="d-sm-flex d-inline" id="route_color_verify">
                                        <div class="input-group">
                                            <input type="text" class="form-control using-custom-font custom-input-disabled" id="verify_name_color_route_1" disabled>
                                ...
                                <div class="form-group mb-1">
                                    ...
                                    <input type="text" class="form-control text-center using-custom-font custom-input-disabled" id="verify_service_route_status" disabled>
                                </div>
                            </form>
                            <hr>
        ...
        <div class="modal fade" id="saveChangeData" tabindex="2" role="dialog" aria-labelledby="saveChangeDataTitle" aria-hidden="true" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" id="modalContentSaveChangeData">
                    <div class="modal-header">
                        <h5 class="modal-title using-custom-font"> เปลี่ยนแปลงเส้นทางเดินรถ</h5>
                    </div>
                    <div class="modal-body" id="modalBodySaveChangeData">
                        <div>
                            <form>
                                <div class="form-group mb-1">
                                    <label class="custom-form-label">รหัสผ่านบัญชีผู้ดูแล (คุณ) ที่จะแก้ไขข้อมูล</label>
                    ...
                    <div class="modal-footer" id="modelSaveChangeDataFooter">
                        <button type="button" class="btn btn-danger mr-auto using-custom-font" onclick="closeModal('#saveChangeData')"><i class="fas fa-times"></i> ยกเลิก</button>
                        <button type="button" class="btn btn-primary using-custom-font" onclick="saveChangeData()"><i class="fas fa-save"></i> บันทึกข้อมูล</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript" src="/TRC_Tracking/src/js/route_management/edit_route_management.js"></script>
</body>
