...
$menu_page_name = "add_trip_management";
...
<body class="sidebar-mini layout-fixed sidebar-collapse">
                                            ...
                                            <div class="row">
                                                <div class="row pl-3 pr-0 mb-3 w-100">
                                                    ...
                                                    <div class="form-group col-md-6 col-12 pl-md-2 pr-md-2 pl-0 pr-0 mb-md-1 mb-2">
                                                        ...
                                                        <div class="d-flex">
                                                            <select class="using-custom-font form-control custom-input-disabled col ml-0 mr-1" id="datepicker_day" disabled>
                                                                <option value="0" selected disabled>วัน</option>
                                                            </select>
                                                            <select class="using-custom-font form-control custom-input-disabled col ml-1 mr-1" id="datepicker_month" disabled>
                                                                <option value="0" selected disabled>เดือน</option>
                                                            </select>
                                                            <select class="using-custom-font form-control custom-input-disabled col ml-1 mr-0" id="datepicker_year" disabled>
                                                    ...
                                                    <div class="form-group col-md-6 col-12 pl-md-2 pr-md-2 pl-0 pr-0 mb-md-1 mb-2">
                                                        ...
                                                        <select class="using-custom-font form-control" name="service_route" onchange="setIdRouteParam(this.value)">
                                                            <option value="*">-</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="row pl-3 pr-0 w-100">
                                                    <div class="col-12 pl-0 mt-1 mb-2">
                                                        <label class="custom-form-header">ตารางเส้นทางเดินรถ</label>
                                                    </div>
                                                    <div class="form-group col-12 pl-md-2 pr-md-2 pl-0 pr-0 mb-md-3 mb-2">
                                                        <div class="col-md-8 col-12 d-md-flex d-block mx-auto">
                                                            <button type="button" class="btn btn-block btn-outline-primary using-custom-font m-0 mr-md-2 mr-0 mb-md-0 mb-2" id="switchRouteForward" onclick="switchRouteMode('forward')" disabled>รอบเดินรถ เที่ยวขาไป</button>
                                                            <button type="button" class="btn btn-block btn-outline-primary using-custom-font m-0 ml-md-2 ml-0 mb-md-0 mb-2" id="switchRouteBackward" onclick="switchRouteMode('backward')" disabled>รอบเดินรถ เที่ยวขากลับ</button>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <table class="table text-nowrap using-custom-font table-bordered">
                                                                ...
                                                                <tbody id="tableBody">
                                                                    <tr name="trNo_0" class="bg-disabled">
                                                                        <td colspan="4" class="text-center text-danger"><i class="far fa-times-circle"></i> รายการเส้นทางเดินรถยังไม่ถูกเลือก</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                    ...
                    <div class="modal-body" id="modalVerifyBody">
                        <div>
                            <form>
                                ...
                                <div class="form-group mb-1">
                                    <label class="custom-form-label">จำนวนรอบให้บริการ (เที่ยวขาไป | เที่ยวขากลับ)</label>
                                ...
                                <div class="form-group mb-1">
                                    <label class="custom-form-label">จำนวนรอบให้บริการที่ยกเลิกทั้งหมด (เที่ยวขาไป | เที่ยวขากลับ)</label>
    ...
    <script type="text/javascript" src="/TRC_Tracking/src/js/trip_management/add_trip_management.js"></script>
</body>
